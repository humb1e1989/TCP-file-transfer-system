...
SERVER2 = {'mac': '00:00:00:00:00:02',
           'ip': '10.0.1.3'}
SERVER1 = {'mac': '00:00:00:00:00:01',
           'ip': '10.0.1.2'}
...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        self.mac_to_port.setdefault(dpid, {'00:00:00:00:00:02': 3, '00:00:00:00:00:01': 2})
        ...
        # print(dst, '   ',SERVER2['mac'],'    ',self.mac_to_port[dpid])
        ...
        if src == SERVER2['mac'] and out_port != ofproto.OFPP_FLOOD:
